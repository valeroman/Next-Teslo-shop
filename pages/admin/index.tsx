...
import { DashboardSummayResponse } from '../../interfaces/dashboard';

const DashboardPage = () => {

    const { data, error } = useSWR<DashboardSummayResponse>('/api/admin/dashboard', {
